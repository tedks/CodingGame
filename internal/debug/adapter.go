...
// Register registers an adapter. Safe for concurrent use.
...
// Get returns an adapter for the given language. Safe for concurrent use.
...
// Languages returns all registered languages. Safe for concurrent use.
